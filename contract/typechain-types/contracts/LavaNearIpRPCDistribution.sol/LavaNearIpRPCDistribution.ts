...
export declare namespace LavaNearIpRPCDistribution {
...
export interface LavaNearIpRPCDistributionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "backupOwner"
      | "deposit"
  ...
  encodeFunctionData(
    ...
    values: [LavaNearIpRPCDistribution.ProviderStruct[]]
  ): string;
  encodeFunctionData(
...
export interface LavaNearIpRPCDistribution extends BaseContract {
  connect(runner?: ContractRunner | null): LavaNearIpRPCDistribution;
  waitForDeployment(): Promise<this>;

  interface: LavaNearIpRPCDistributionInterface;
  ...
  payProviders: TypedContractMethod<
    [providers: LavaNearIpRPCDistribution.ProviderStruct[]],
    [void],
    "nonpayable"
  >;
